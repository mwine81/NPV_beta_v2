...
# tab1,tab2,tab3=st.tabs(['Module','Input','About'])
...
with col1:
    ...
    development_time_phase_1 = st.number_input(label='Development Time Phase 1', value=2.95, key='development_time_phase_1')
    development_time_phase_2 = st.number_input(label='Development Time Phase 2', value=3.35, key='development_time_phase_2')
    development_time_phase_3 = st.number_input(label='Development Time Phase 3', value=3.65, key='development_time_phase_3')
    development_time_registration = st.number_input(label='Development Time Registration', value=1.05, key='development_time_registration')


with col2:

    development_cost_phase_1 = st.number_input(label='Development Cost Phase 1', value=34_900_000, key='development_cost_phase_1')
    development_cost_phase_2 = st.number_input(label='Development Cost Phase 2', value=102_600_000, key='development_cost_phase_2')
    development_cost_phase_3 = st.number_input(label='Development Cost Phase 3', value=334_800_000, key='development_cost_phase_3')
    development_cost_registration = st.number_input(label='Development Cost Registration', value=89_300_000, key='development_cost_registration')
...
update_app = st.button('Update App')
if update_app:
    st.rerun()
...
st.write(price_evolution_frame().collect())
...
st.write('NPV')
st.write(npv_calculation(run_global()))
